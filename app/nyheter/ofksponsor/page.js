  ...
  return (
    <div className={styles.details}>
      ...
      <p>
        ...
        att etablera produktion i Östersund. Men för att börja tillverka
        läkemedel krävs både patent och godkännande från Läkemedelsverket. Och
        nu har Auxesis registrerat det förstnämnda. – Vi har registrerat de
        verksamma delarna, berättar Roar Adelsten, VD för det nystartade
        bolaget. Idén går ut på att stabilisera smärtstillande aspirin som
        normalt löses i form av en brustablett. I stället vill Auxesis ta fram
        ett sätt att tillverka den smärtstillande medicinen i produkter som
        appliceras direkt på huden. Salva har nämnts tidigare men först ut
        kommer en våtservett att tillverkas, enligt Roar Adelsten.
      </p>
      <p>
        ...
        ansöka om ett marknadsgodkännande från Läkemedelsverket.  – Vid nyår ska
        vi ta beslut om vi ska hyra en befintlig lokal i Östersund eller om vi
        ska bygga nytt från scratch. Vi har kikat på lokaler och det är höga
        krav som ställs i och med att det är tillverkning av ett farmaceutiskt
        preparat. En fördel är förstås att äga lokalen själva, men det är inte
        bestämt ännu, säger Roar Adelsten.
      </p>
      <p>
