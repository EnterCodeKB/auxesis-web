      ...
      <div className={styles.produkt}>
        ...
        <p className={styles.ptext}>
          ...
          <li>
            ...
            läkemedel för människor – i Sverige, EU, USA, Kina och
            Storbritannien med pågående ansökan om varumärkesregistrering på den
            globala marknaden i över 30 länder. Vi har godkända ansökningar i 29
            länder (juli 2024).
          </li>
        </p>
        ...
        <p className={styles.ptext}>
          ...
          <p>De flesta känner till läkemedel som Treo, Bamyl och Aspirin. </p>
          <p>
            Efter 10 års forskning och mer än 5 000 försök har Auxesis Pharma
            tillsammans med professor Moustapha Hassan och hans team på
            Karolinska Institutet i Stockholm, lyckats göra det som ingen annan
            har gjort tidigare: Att stabilisera{" "}
          </p>
          <p>
            ASA i flytande form och i kombination med andra godkända läkemedel.
            Med ASA i flytande form finns möjligheter att utveckla helt nya
            beredningsformer som enkelt kan appliceras direkt på huden och
            blockera smärtsignalen till hjärnan inom 4-6 minuter. Genom att
            tillsätta två andra farmaceutiska aktiva substanser erhålls en
            långtidseffekt.
          </p>{" "}
          <p>
            {" "}
