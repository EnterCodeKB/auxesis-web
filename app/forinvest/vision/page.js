...
import styles from "../../styles/InvestVision.module.css";
      ...
      <section className={styles.vision}>
        ...
        <div className={styles.whiteboard4}>
          <div className={styles.container1}>
            ...
            <div
              ref={effektRef}
              className={`${styles.effekt} ${styles.hidden}`}
            >
          ...
          <div className={styles.affärside}>
            ...
            <p className={styles.ptext}>
              ...
              smärtsignalen till hjärnan. Genom att tillsätta andra
              farmaceutiskt aktiva substanser bibehålls effekten till dess att
              kroppen har läkt sig själv. Studier pekar på att ASA.P stannar på
              huden och inte går ut i blodomloppet.
            </p>
            <p className={styles.ptext}>
