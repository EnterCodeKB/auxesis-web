...
import HeroHallbarhet from "../../components/HeroSectionHallbarhet";
      ...
      <section className={styles.halbara}>
        ...
        <div className={styles.section31}>
          ...
          <p className={styles.ptext}>
            ...
            miljöpåverkan som möjligt innebär ett dagligt arbete med att
            utvärdera vilka faser i vår utveckling, forskning, produktion och
            försäljning som kan påverka miljön.
          </p>
        </div>
        <div className={styles.section42}>
          ...
          <p className={styles.ptext}>
            ...
            det förbrukade preparatet ska kunna läggas i avfallssortering eller
            lämnas till apotekens återvinningssystem eller motsvarande i andra
            länder. Det bidrar till en mer hållbar tillväxt för Auxesis Pharma
            och för samhället.
          </p>
        </div>
      </section>
